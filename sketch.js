...
drawOne = function() {
   ...
   fill(0,0,0);
   text("So Mad!!!", width/2, height - 5* gTextOffset);
...
drawTwo = function() {
   ...
   fill(240,120,0);
   text("What is going on???", width/2, height - 5* gTextOffset);
...
drawThree = function() {
   ...
   fill(40,230,120);
   text("ummmm...I don't know what to say", width/2, height - 5* gTextOffset);
...
drawFour = function() {
   ...
   fill(255,255,178);
   text("Happy day, Happy life", width/2, height - 5* gTextOffset);
...
drawFive = function() {
   ...
   fill(230,50,50);
   text("yowl~~~~~~, yowl~~~~~~", width/2, height - 5* gTextOffset);
...
function loadArray() {
  strings[0] = "press number 1-5 to see  mood";
  strings[1] = "";
  strings[2] = "press 's' back to the Splash page";
  strings[3] = "";
  strings[4] = "press 'i' back to Instruction";
  fill(255);
